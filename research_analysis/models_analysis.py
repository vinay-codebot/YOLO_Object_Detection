...
plt.legend()
plt.savefig("outputs/plots/confidence_comparison.png")
plt.show()  
...
plt.legend()
plt.savefig("outputs/plots/accuracy_with_anamolies_vs_frame.png")
plt.show()
...
plt.legend()
plt.savefig("outputs/plots/fps_comparison.png") 
plt.show() 
...
plt.legend()
plt.savefig("outputs/plots/accuracy_vs_speed.png")
plt.show()
...
print(metrics_table)
# Save metrics table
metrics_table.to_csv("outputs/logs/summary_metrics.csv")
